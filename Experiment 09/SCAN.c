...
int main() {
    ...
    sequence[sequenceSize + 1] = direction == 1 ? diskSize -1 : 0; // Add either the first or last disk position
    sequenceSize += 2; // Accommodate for the 2 new elements inserted above
    ...
    repositioningIndex = index - direction; // set the repositioning index based on the direction
    prevIndex = index;
